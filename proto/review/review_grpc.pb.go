...
const (
	...
	ReviewService_CheckReviewStatus_FullMethodName = "/review.ReviewService/CheckReviewStatus"
)
...
type ReviewServiceClient interface {
	...
	CheckReviewStatus(ctx context.Context, in *CheckReviewStatusRequest, opts ...grpc.CallOption) (*CheckReviewStatusResponse, error)
}
...
func (c *reviewServiceClient) CheckReviewStatus(ctx context.Context, in *CheckReviewStatusRequest, opts ...grpc.CallOption) (*CheckReviewStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckReviewStatusResponse)
	err := c.cc.Invoke(ctx, ReviewService_CheckReviewStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReviewServiceServer interface {
	...
	// 获取商品是否有当前用户的评价 (用于前端判断显示"已评价")
	CheckReviewStatus(context.Context, *CheckReviewStatusRequest) (*CheckReviewStatusResponse, error)
...
func (UnimplementedReviewServiceServer) CheckReviewStatus(context.Context, *CheckReviewStatusRequest) (*CheckReviewStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckReviewStatus not implemented")
}
...
func _ReviewService_CheckReviewStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckReviewStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServiceServer).CheckReviewStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReviewService_CheckReviewStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServiceServer).CheckReviewStatus(ctx, req.(*CheckReviewStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReviewService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckReviewStatus",
			Handler:    _ReviewService_CheckReviewStatus_Handler,
		},
	},
