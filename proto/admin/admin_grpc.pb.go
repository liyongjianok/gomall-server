...
const (
	...
	AdminService_BatchUpdatePrice_FullMethodName  = "/admin.AdminService/BatchUpdatePrice"
...
type AdminServiceClient interface {
	...
	BatchUpdatePrice(ctx context.Context, in *BatchPriceRequest, opts ...grpc.CallOption) (*BatchPriceResponse, error)
	// --- 订单管理 ---
...
func (c *adminServiceClient) BatchUpdatePrice(ctx context.Context, in *BatchPriceRequest, opts ...grpc.CallOption) (*BatchPriceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchPriceResponse)
	err := c.cc.Invoke(ctx, AdminService_BatchUpdatePrice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServiceServer interface {
	...
	BatchUpdatePrice(context.Context, *BatchPriceRequest) (*BatchPriceResponse, error)
	// --- 订单管理 ---
...
func (UnimplementedAdminServiceServer) BatchUpdatePrice(context.Context, *BatchPriceRequest) (*BatchPriceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchUpdatePrice not implemented")
}
...
func _AdminService_BatchUpdatePrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchPriceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).BatchUpdatePrice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_BatchUpdatePrice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).BatchUpdatePrice(ctx, req.(*BatchPriceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AdminService_BatchUpdatePrice_Handler,
		},
		{
